...
<Fade bottom>
            <div className=" px-6 py-4 space-x-10 justify-around">
              <a
                ...
                href='https://api.whatsapp.com/send?phone=9979583428'
                rel='noreferrer'
                target='_blank'
              >
                Hire me
              </a>
              <a className="bg-blue-500 hover:bg-blue-700 text-white font-bold px-4 py-2 rounded" href={pdf} download="my_resume.pdf">
                My Resume
              </a>
            </div>
            </Fade>
            ...
            <div
              ...
              <div className="  space-y-2">
                ...
                <ul className="flex space-x-5">
                  ...
                  <li>
                    <a href="https://www.linkedin.com/in/jaydeep-sagalaka-6407a62a0/" target="_blank">
